    ...
    return (
      <FormField label={label} htmlFor={selectId} required={required} error={error} hint={hint}>
        <select
          ...
          className={`block w-full rounded-md border bg-surface px-3 py-2 text-sm text-foreground focus:outline-2 focus:outline-offset-2 focus:outline-primary disabled:cursor-not-allowed disabled:bg-muted disabled:text-muted-foreground ${
